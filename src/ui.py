...
"")
        ...
        self.elementVeiwer = QListWidget(self.centralwidget)
        self.elementVeiwer.setObjectName(u"elementVeiwer")
        self.elementVeiwer.setGeometry(QRect(0, 0, 161, 621))
        self.line = QFrame(self.centralwidget)
        self.line.setObjectName(u"line")
        self.line.setGeometry(QRect(-10, -10, 801, 20))
        ...
        self.titleLabel.setGeometry(QRect(150, 30, 271, 51))
        self.formLayoutWidget = QWidget(self.details)
        self.formLayoutWidget.setObjectName(u"formLayoutWidget")
        self.formLayoutWidget.setGeometry(QRect(150, 80, 271, 141))
        ...
        self.packGenerate = QPushButton(self.details)
        self.packGenerate.setObjectName(u"packGenerate")
        self.packGenerate.setGeometry(QRect(150, 230, 271, 31))
        ...
        self.blockTextureButtonBottom.setGeometry(QRect(280, 140, 50, 50))
        ...
        self.blockTextureButtonTop.setGeometry(QRect(280, 40, 50, 50))
        ...
        self.blockTextureButtonLeft.setGeometry(QRect(230, 90, 50, 50))
        ...
        self.blockTextureButtonBack.setGeometry(QRect(280, 90, 50, 50))
        ...
        self.blockTextureButtonFront.setGeometry(QRect(380, 90, 50, 50))
        ...
        self.blockTextureButtonRight.setGeometry(QRect(330, 90, 50, 50))
        ...
        self.blockTextureLabel.setGeometry(QRect(220, 10, 49, 16))
        self.layoutWidget = QWidget(self.blockEditor)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(10, 10, 197, 216))
        ...
        self.layoutWidget1.setGeometry(QRect(10, 0, 258, 382))
        ...
        self.paintingTextureButton.setGeometry(QRect(440, 10, 50, 50))
        ...
        self.paintingTextureLabel.setGeometry(QRect(390, 30, 58, 15))
        self.layoutWidget2 = QWidget(self.paintingEditor)
        self.layoutWidget2.setObjectName(u"layoutWidget2")
        self.layoutWidget2.setGeometry(QRect(10, 0, 359, 186))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionPaintings.setText(QCoreApplication.translate("MainWindow", u"Painting", None))
        self.actionItems.setText(QCoreApplication.translate("MainWindow", u"Item", None))
...
"Created By JupiterDev & JustJoshinDev 2025", None))
        ...
        self.packName.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>The name of your Data &amp; Resource packs!</p></body></html>", None))
...
#if QT_CONFIG(tooltip)
        self.packNamespace.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>The namespace for your packs. This is what the game uses to recognize your packs.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.packAuthor.setWhatsThis(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>You!</p></body></html>", None))
...
#if QT_CONFIG(tooltip)
        self.packDescription.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>The description for your packs!</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.packVersion.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>The version your packs will work for.<br/><span style=\" font-weight:700;\">1.21.4 highly recommended!</span></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
